    ...
    <footer className="bg-[#E8E6E1] text-[#4A3728] mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          <div>
            <h3 className="text-xl font-serif text-[#8D4F38] mb-3">Esscentia</h3>
            <p className="text-sm text-stone-600 leading-relaxed max-w-sm">
              Toko parfum premium dengan koleksi eksklusif dari brand ternama dunia.
            </p>
          </div>
          <div>
            <h4 className="text-[10px] uppercase tracking-[0.2em] text-stone-500 mb-4">
              Bantuan
            </h4>
            <ul className="space-y-2 text-sm text-stone-600">
              <li>
                <Link href="/faq" className="hover:text-[#8D4F38] transition">
                  Shipping &amp; Returns
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-[#8D4F38] transition">
                  Hubungi Kami
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-stone-600">
              <li>
                <Link href="/privacy" className="hover:text-[#8D4F38] transition">
                  Kebijakan Privasi
                </Link>
              </li>
              <li>
                <Link href="/terms" className="hover:text-[#8D4F38] transition">
                  Syarat &amp; Ketentuan
                </Link>
              </li>
            </ul>
